...
import re
import jieba
jieba.load_userdict("state_dict/data/jieba_dic.txt")
...
class T5PegasusTokenizer(Tokenizer):
    def __init__(self, token_dict, pre_tokenizer=lambda x: jieba.cut(x)): #TODO
...
if __name__ == "__main__":
    word2idx = load_chinese_base_vocab(vocab_path="../examples/state_dict/vocab") #"./state_dict/t5-chinese/vocab.txt")
    # print(word2idx)
    # print(keep_tokens)
    ...
    input_ids, segment_ids = tokenizer.encode("三清站#1主变110kV侧1101开关永久故障_开关节点AB相相间接地")
